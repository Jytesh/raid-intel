	...
	nations?:
		| {
				...
				data: Array<{
					...
					nation_name?: string | null | undefined;
					leader_name?: string | null | undefined;
					alliance_id?: string | null | undefined;
					score?: number | null | undefined;
					soldiers?: number | null | undefined;
					tanks?: number | null | undefined;
					aircraft?: number | null | undefined;
					ships?: number | null | undefined;
					missiles?: number | null | undefined;
					nukes?: number | null | undefined;
					alliance?:
						| {
								__typename?: 'Alliance';
								id?: string | null | undefined;
								sent_treaties: Array<{
									__typename?: 'Treaty';
									alliance1?:
										| { __typename?: 'Alliance'; id?: string | null | undefined }
										| null
										| undefined;
									alliance2?:
										| { __typename?: 'Alliance'; id?: string | null | undefined }
						...
						| null
						| undefined;
					cities: Array<{ __typename?: 'City'; id?: string | null | undefined }>;
					defensive_wars: Array<{
						__typename?: 'War';
						...
						attacks: Array<{
							...
							moneystolen?: number | null | undefined;
							loot_info?: string | null | undefined;
						}>;
					}>;
				}>;
		  }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
	return {
		getNation(
			variables: GetNationQueryVariables,
			requestHeaders?: Dom.RequestInit['headers']
		): Promise<GetNationQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetNationQuery>(GetNationDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getNation'
		...
		getNationsData(
			variables: GetNationsDataQueryVariables,
			requestHeaders?: Dom.RequestInit['headers']
		): Promise<GetNationsDataQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetNationsDataQuery>(GetNationsDataDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getNationsData'
